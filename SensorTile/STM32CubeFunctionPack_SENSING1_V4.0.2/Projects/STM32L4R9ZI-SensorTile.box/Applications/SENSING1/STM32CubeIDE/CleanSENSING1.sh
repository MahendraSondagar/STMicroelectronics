...
# example:
#OpenOCD_DIR="C:/Ac6/SystemWorkbench/plugins/fr.ac6.mcu.externaltools.openocd.win32_1.23.0.201904120827/tools/openocd"
OpenOCD_DIR=""

# 2) Set the installation path for stm32 OpenOCD scritps
# example:
#OpenOCD_CFC="C:/Ac6/SystemWorkbench/plugins/fr.ac6.mcu.debug_2.5.0.201904120827/resources/openocd/st_scripts"
OpenOCD_CFC=""
...
# OpenOCD command
OpenOCD_CMD="${OpenOCD_DIR}/bin/openocd -s ${OpenOCD_CFC} -f STM32L4R9I-SensorTileBox.cfg"
...
echo "/******************************************/"
${OpenOCD_CMD} -c "init" -c "reset halt" -c "flash write_image erase ../../../../../Utilities/BootLoader/STM32L4R9ZI/BootLoaderL4R9.bin 0x08000000 bin" -c "shutdown"
echo "/******************************************/"
...
SizeBinBL=`ls -l ./SENSING1.bin | awk '{print $5+0x4000};'`
${OpenOCD_CMD} -c "init" \
			   -c "reset halt" \
